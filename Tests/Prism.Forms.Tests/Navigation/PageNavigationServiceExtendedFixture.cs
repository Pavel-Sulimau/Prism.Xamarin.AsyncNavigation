...
namespace Prism.Forms.Tests.Navigation
{
    public class PageNavigationServiceExtendedFixture : IDisposable
    {
        ...
        {
            var navigationService = new PageNavigationServiceExtendedMock(_container, _applicationProvider, _loggerFacade);
        ...
        public async void Navigate_ToContentPage_ByAbsoluteName()
        {
            ...
            var navigationService = new PageNavigationServiceExtendedMock(_container, applicationProvider, _loggerFacade, recorder);
        ...
        public async void Navigate_ToContentPage_ViewModelHasINavigationAware()
        {
            ...
            var nextPageNavService = new PageNavigationServiceExtendedMock(_container, _applicationProvider, _loggerFacade);
        ...
        {
            var recorder = new PageNavigationEventRecorder();
            var navigationService = new PageNavigationServiceExtendedMock(_container, _applicationProvider, _loggerFacade, recorder);
        ...
        public async void DeepNavigate_ToEmptyMasterDetailPage_ToEmptyNavigationPage_ToContentPage()
        {
            ...
            var navigationService = new PageNavigationServiceExtendedMock(_container, applicationProvider, _loggerFacade);
