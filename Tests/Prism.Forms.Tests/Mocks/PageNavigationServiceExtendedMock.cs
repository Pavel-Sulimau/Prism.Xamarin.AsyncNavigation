...
{
    public class PageNavigationServiceExtendedMock : PageNavigationServiceExtended
    {
        PageNavigationContainerMock _containerMock;
        PageNavigationEventRecorder _recorder;

        public PageNavigationServiceExtendedMock(PageNavigationContainerMock containerMock, IApplicationProvider applicationProviderMock, ILoggerFacade loggerFacadeMock, PageNavigationEventRecorder recorder = null)
