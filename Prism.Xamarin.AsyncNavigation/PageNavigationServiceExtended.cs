...
using Prism.Xamarin.AsyncNavigation.Common;
using Xamarin.Forms;
...
namespace Prism.Xamarin.AsyncNavigation
{
    ...
    public class PageNavigationServiceExtended : INavigationService, IPageAware
    {
        ...
        public PageNavigationServiceExtended(IContainerExtension container, IApplicationProvider applicationProvider, IPageBehaviorFactory pageBehaviorFactory, ILoggerFacade logger)
        {
